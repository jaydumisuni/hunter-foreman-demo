...
The public interface is fully clickable. Use its navigation, buttons, image hotspots, Hunter guide, and **Launch Interactive Demo** to explore the project. **Watch Demo** opens the animated preview, while **Launch Interactive Demo** opens the working browser demo. This repository remains the optional port-3100 App Bridge receiver.
